...
angular.module('clientApp')
    ...
    .controller('GiftDetailCtrl', function($scope, $rootScope, $state, gift) {
        //$rootScope.title = "大礼包";
...
.controller('ShareModalCtrl', function($scope, $modalInstance) {
    ...
    $scope.$watch('isCloseModal', function(val) {
        if (val) $modalInstance.close();
    });
})

// Gift Share 
.controller('GiftShareCtrl', function($state, $scope, $rootScope, $stateParams, $modal, RestGiftOrder, $timeout) {
