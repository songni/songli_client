...
// 送多人
.controller('GiftRecordMultiCtrl', function($scope, $rootScope, $state, $cookies, $timeout, $modal, $window, Alert) {
...
.controller('OrderAddressOne2ManySendCtrl', function($scope, $rootScope, $state, $cookies, Wechat, $location, order, $modal) {
...
.controller('OrderAddressOne2ManyRecevCtrl', function($scope, $rootScope, $state, $stateParams, $cookies, Wechat, RestWechat, $location, order, $modal) {
