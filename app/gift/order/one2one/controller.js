...
// 送单人
.controller('GiftRecordSingleCtrl', function($scope, $rootScope, $state, $cookies, $timeout, $modal, $window, Alert) {
...
.controller('OrderAddressOne2OneCtrl', function($timeout, $scope, $rootScope, $location, $state, $modal, $window, RestGiftOrder, Wechat, order, Alert) {
